...
from logistic_sgd_gray import save_parameters
...
class dA(object):
	...
	def __init__(self, numpy_rng, theano_rng=None, input=None,
				 n_visible=1024, n_hidden=784, # same number as MNIST (32*32)
...
def load_data(dataset, mode='train', amount='full'):
	...
	if mode == 'train':
		...
		if amount == 'full':
			...
			train_set = unpickle('data/test_set_gray_1.pkl')
			train_set = (train_set, [0 for i in xrange(0,len(train_set))])
		print 'done!'
